...
/* Enable Whitelist access to files 白名单访问网页，如果开启，则不能打开网页，原因在找 */
//#define WEBS_WHITELIST_SUPPORT	1	// del by gyr 2011.09.18
...
#define WEBS_CGI_UPLOAD			  0x800000		/* */
#define WEBS_CGI_FIRMWARE_UPLOAD  0x100000		/* */
#define WEBS_CGI_ROOTFS_UPLOAD	  0x200000		/* */
#define WEBS_CGI_LINUX_UPLOAD	  0x400000		/* */
#define WEBS_CGI_ALL_UPLOAD	 	  0x800000		/* */



//#define WEBS_GOFORM_FIRMWARE_UPLOAD 0x200000	/* */

#define CGI_UPLOAD				T("upload")
#define CGI_FIRMWARE_UPLOAD		T("upload_app.cgi")
#define CGI_ROOTFS_UPLOAD		T("upload_fs.cgi")
#define CGI_LINUX_UPLOAD		T("upload_linux.cgi")
#define CGI_ALL_UPLOAD			T("upload_all.cgi")


#define WEBS_FIRMWARE_UPLOAD    "uploadFW"
/*
 *	URL handler flags
 */
