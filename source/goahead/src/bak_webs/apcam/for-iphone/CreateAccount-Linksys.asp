...
<body  onLoad="ACOUNTinitValue();">
	<div id="jqt">
		<div class="current">
			...
			<div id="page">
				<div class="head"><p style="padding-left:10px;font-size:16px"><script>document.write(language3[18])</script><p></div>
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-left:6px; margin-right:6px;margin-top:5px;margin-bottom:5px;" >
						...
						<div onClick=" document.getElementById('seedonk_lastname').focus();" class="seedonk_passwd">
							<div style ="float:left;height:30px; margin-top:0px" id="lastname_width"><script>document.write(language3[15])</script></div>
						...
						<div onClick=" document.getElementById('seedonk_login').focus();" class="seedonk_repasswd" >
							<div style ="float:left;height:30px; margin-top:2px" id="login_width"><script>document.write(language3[6])</script></div>
				...
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-left:6px; margin-right:6px;margin-top:5px;margin-bottom:5px;" >
						<div onClick=" document.getElementById('seedonk_passwd').focus();" class="seedonk_email">
							<div style ="float:left;height:30px; margin-top:5px" id="passwd_width"><script>document.write(language3[4])</script></div>
