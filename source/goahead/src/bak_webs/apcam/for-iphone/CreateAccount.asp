				...
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-left:6px; margin-right:6px;margin-top:5px;margin-bottom:5px;" >
						...
						<div onClick=" document.getElementById('seedonk_passwd').focus();" class="seedonk_passwd">
							<div style ="float:left;height:30px; margin-top:2px" id="passwd_width"><script>document.write(language3[4])</script>:</div>
						...
						<div onClick=" document.getElementById('seedonk_repasswd').focus();" class="seedonk_repasswd">
							<div style ="float:left;height:30px; margin-top:2px" id="repasswd_width"><script>document.write(language3[5]+" "+language3[4])</script>:</div>
						...
						<div onClick=" document.getElementById('seedonk_email').focus();" class="seedonk_repasswd">
							<div style ="float:left;height:30px; margin-top:2px" id="email_width"><script>document.write(language3[6])</script>:</div>
						...
						<div onClick=" document.getElementById('seedonk_reemail').focus();" class="seedonk_email">
							<div style ="float:left;height:30px; margin-top:5px" id="reemail_width"><script>document.write(language3[5]+" "+language3[6])</script>:</div>
