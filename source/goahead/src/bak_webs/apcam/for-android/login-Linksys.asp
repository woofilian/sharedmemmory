	...
	<div id="jqt">
		<div class="current">
			...
			<div id="page">
				...
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-left:6px; margin-right:6px;margin-top:10px;margin-bottom:10px;" >
						<div onClick="document.getElementById('owner_name').focus();" class="owner_name" id="box_name">
							<div style ="float:left;height:28px;margin-top:5px" id="name_width"><script>document.write(language3[6])</script></div>
				...
				<div id = "display" class="login"><script>document.write("")</script></div><br><br><br><br><br>	
				<div id="loginbutton">
