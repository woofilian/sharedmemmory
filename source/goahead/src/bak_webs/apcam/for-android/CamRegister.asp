	...
	<div id="jqt">
		<div class="current">
			...
			<div id="page">
				...
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-top:5px; margin-left:6px; margin-right:6px;margin-top:10px;margin-bottom:10px;" id="box_all">
						<div onClick="document.getElementById('cameraname').focus();" class="cameraname" id="box_cameraname">
							<div style ="float:left;height:25px;margin-top:3px;white-space:nowrap;" id="cameraname_width"><script>document.write(language5[3])</script></div>
						...
						<div onClick="document.getElementById('cameradesc').focus();" class="cameradesc" id="box_cameradesc">
							<div style ="float:left;height:25px;margin-top:5px" id="cameradesc_width"><script>document.write(language5[4])</script></div>
							<div style ="float:right;" id="edit_cameradesc"><input type="text"  name="cameradesc" id = "cameradesc" class="cameradescInput" autocorrect="off" autocapitalize="off" autocomplete="off" /></div>
						</div>
					</div>
				</ul>
