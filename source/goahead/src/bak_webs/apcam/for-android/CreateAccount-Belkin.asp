	...
	<div id="jqt">
		<div class="current">
			...
			<div id="page">
				...
				<ul class="rounded">
					<div style="background-color:#FFFFFF; margin-left:6px; margin-right:6px;" >
						<div onClick=" document.getElementById('seedonk_login').focus();" class="seedonk_login" id="box_login">
							<div style ="float:left;height:25px;margin-top:2px;" id="login_width" ><script>document.write(language3[3])</script></div>
							<div style ="float:right;" id="edit_login"><input type="text" name="seedonk_login" id="seedonk_login" class="loginInput" autocorrect="off" autocapitalize="off" autocomplete="off" /></div>
						</div>
						...
						<div onClick=" document.getElementById('seedonk_repasswd').focus();" class="seedonk_repasswd">
							<div style ="float:left;height:25px;margin-top:2px;" id="repasswd_width"><script>document.write(language3[5])</script></div>
						...
						<div onClick=" document.getElementById('seedonk_email').focus();" class="seedonk_email">
