...
<!--    -->
<HEAD>
<TITLE> <% getWebserverName(); %>  WebServer</TITLE>
...
<FRAMESET COLS="180,1*" COLS="*" BORDER="0" FRAMESPACING="0" FRAMEBORDER="NO" onLoad="onInit()"> 
    ...
    <FRAME SRC="ralink\treeapp.asp" NAME="menu" MARGINWIDTH="0" MARGINHEIGHT="0" scrolling="AUTO" FRAMEBORDER="NO" >

    <FRAME SRC="ralink\overview.asp" NAME="view" SCROLLING="AUTO" MARGINWIDTH="0" TOPMARGIN="0" MARGINHEIGHT="0" FRAMEBORDER="NO">
