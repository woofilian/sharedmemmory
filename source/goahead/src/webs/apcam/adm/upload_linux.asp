<html><head><title>Upload Linux</title>
...
document.write('<div id="loading" style="display: none;"><br><br><br>Uploading Linux <br><br> Please be patient and don\'t remove usb device if it presented...</div>');
...
<h1 id="uploadTitle">Upgrade Linux</h1>
<p><font id="uploadIntroduction1">Upgrade the SoC Linux to obtain new functionality. </font><font id="uploadIntroduction2" color="#ff0000">It takes about 1 minute to upload &amp; upgrade flash and be patient please. Caution! A corrupted image will hang up the system.</font> </p>

<br>
<br>

<!-- ----------------- Upload firmware Settings ----------------- -->
<form method="post" name="UploadFirmware" action="/cgi-bin/upload_linux.cgi" enctype="multipart/form-data">
<table border="1" cellpadding="2" cellspacing="1" width="95%">
<tbody>
<tr>
  <td class="title" colspan="2" id="uploadFW">Update Linux</td>
</tr>
<tr>
