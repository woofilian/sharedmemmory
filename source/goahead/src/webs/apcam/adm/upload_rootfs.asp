<html><head><title>Upload RoofFS</title>
...
document.write('<div id="loading" style="display: none;"><br><br><br>Uploading RootFS <br><br> Please be patient and don\'t remove usb device if it presented...</div>');
...
<h1 id="uploadTitle">Burnin RootFS</h1>
