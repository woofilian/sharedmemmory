...
typedef struct awb_m2_param {
    int             rgb_min;
    int             rgb_max;
    grey_th_t       grey_th;
    grey_ext_th_t   cwf_th;
    gamut_th_t      gamut_th[6];
    int             outdoor_ctmp_wgt[6];
} awb_m2_param_t;
...
#define ISP_IOC_GET_CURR_FPS            _IOR(ISP_IOC_COMMON, 17, int)
...
#define ISP_IOC_GET_VCAP_YUV_RANGE      _IOR(ISP_IOC_COMMON, 134, int)
#define ISP_IOC_SET_VCAP_YUV_RANGE      _IOW(ISP_IOC_COMMON, 134, int)
#define ISP_IOC_GET_VCAP_SIZE           _IOR(ISP_IOC_COMMON, 135, struct win_size)
#define ISP_IOC_GET_DEMON_VER           _IOR(ISP_IOC_COMMON, 136, u32)
...
#define ISP_IOC_GET_DAYNIGHT_MODE       _IOR(ISP_IOC_MW, 10, int)
#define ISP_IOC_SET_DAYNIGHT_MODE       _IOW(ISP_IOC_MW, 10, int)
...
#define ISP_IOC_GET_ADJUST_DPC_EN       _IOR(ISP_IOC_MW, 70, int)
#define ISP_IOC_SET_ADJUST_DPC_EN       _IOW(ISP_IOC_MW, 70, int)
...
#define ISP_IOC_SET_MRNR_LEVEL          _IOW(ISP_IOC_MW, 204, int)
...
#define LENS_IOC_GET_CHECK_BUSY         _IOR(ISP_IOC_LENS, 8, int)
#define LENS_IOC_GET_ZOOM_POS           _IOW(ISP_IOC_LENS, 9, int)
#define LENS_IOC_SET_ZOOM_POS           _IOW(ISP_IOC_LENS, 10, int)
...
#define AE_IOC_GET_EV_EXP_TAB           _IOR(ISP_IOC_AE, 32, int *)
#define AE_IOC_SET_EV_EXP_TAB           _IOW(ISP_IOC_AE, 32, int *)
#define AE_IOC_GET_EV_GAIN_TAB          _IOR(ISP_IOC_AE, 33, int *)
#define AE_IOC_SET_EV_GAIN_TAB          _IOW(ISP_IOC_AE, 33, int *)
#define AE_IOC_SET_SYNC_WIN             _IOW(ISP_IOC_AE, 34, ae_win_cfg_t *)
#define AE_IOC_GET_STATUS               _IOR(ISP_IOC_AE, 35, int *)
#define AE_IOC_GET_MIN_SENSOR_GAIN      _IOR(ISP_IOC_AE, 36, u32)
#define AE_IOC_SET_MIN_SENSOR_GAIN      _IOW(ISP_IOC_AE, 36, u32)
#define AE_IOC_GET_MAX_SENSOR_GAIN      _IOR(ISP_IOC_AE, 37, u32)
#define AE_IOC_SET_MAX_SENSOR_GAIN      _IOW(ISP_IOC_AE, 37, u32)
#define AE_IOC_GET_CURRENT_GAIN         _IOW(ISP_IOC_AE, 38, u32)
#define AE_IOC_GET_PD_FACTOR            _IOR(ISP_IOC_AE, 39, u32 *)
#define AE_IOC_SET_PD_FACTOR            _IOW(ISP_IOC_AE, 39, u32 *) 
//=============================================================================
...
#define AWB_IOC_GET_STATUS              _IOR(ISP_IOC_AWB, 13, int *)
...
#define AWB_IOC_GET_METHOD2_PARAM       _IOR(ISP_IOC_AWB, 220, awb_m2_param_t *)
#define AWB_IOC_SET_METHOD2_PARAM       _IOW(ISP_IOC_AWB, 220, awb_m2_param_t *)
#define AWB_IOC_GET_GAMUT_NEGATIVE_TH   _IOR(ISP_IOC_AWB, 221, int)
#define AWB_IOC_SET_GAMUT_NEGATIVE_TH   _IOW(ISP_IOC_AWB, 221, int)
...
#define AF_IOC_GET_STATUS               _IOR(ISP_IOC_AF, 6, int *)
#define AF_IOC_SET_BACKLASH_ENABLE      _IOR(ISP_IOC_AF, 7, int)
