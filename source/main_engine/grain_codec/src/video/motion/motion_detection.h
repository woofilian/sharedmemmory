...
struct mdt_result_t {
    void *bindfd; 
    int ch_result;
    struct mdt_reg_result_t  *sub_region;
    int sub_region_num;
};
...
struct mdt_user_t {
    struct mv_cfg_t  mv_param;          /*  param for motion data */
     mdt_alg_t mdt_alg;           /*  param for motion detection application */
