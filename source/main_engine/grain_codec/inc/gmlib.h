...
typedef struct  {
    ...
    int path;
    int enable_mv_data;
    int I2P_threshold; ///< (unit is percentage) interlace to progressive threshold, default is 60 means 60%
...
typedef struct  {
    ...
    int bitrate;  ///< ADPCM: 16000/32000  AAC: 10000~50000
 ...
 * @brief Set the CVBS display vision
 * @param lcd_vch The vch of LCD display (GM_LCD0, GM_LCD1...)
 * @param x The x coordinate of CVBS
 * @param y The y coordinate of CVBS
 * @param width The width of CVBS
 * @param height The height of CVBS
 * @return 0 on success(成功), -1 on error(失败)
 */
 ...
 * @param notify the type of this notification
 * @param fn_notify_handler callback function for notify
